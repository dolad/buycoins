...
__decorate([
    ...
    typegoose_1.prop({ required: true }),
    __metadata("design:type", String)
], PaymentDetails.prototype, "amount", void 0);
__decorate([
    type_graphql_1.Field(),
    typegoose_1.prop({ required: true }),
    __metadata("design:type", String)
], PaymentDetails.prototype, "currrency", void 0);
__decorate([
    type_graphql_1.Field(),
    typegoose_1.prop({ required: false }),
    __metadata("design:type", String)
], PaymentDetails.prototype, "user_email", void 0);
__decorate([
    type_graphql_1.Field(_type => String),
    typegoose_1.prop({ ref: User_1.User, required: true }),
    __metadata("design:type", Object)
], PaymentDetails.prototype, "user", void 0);
